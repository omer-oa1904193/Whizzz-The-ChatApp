...
public class DatabaseViewModel extends ViewModel {
    ...
    public void addChatDb(String receiverId, String senderId, String message, String timestamp, String symmetricKeyForSender, String symmetricKeyForReceiver) {
        successAddChatDb = instance.addChatsInDatabase(receiverId, senderId, message, timestamp, symmetricKeyForSender, symmetricKeyForReceiver);
    }
