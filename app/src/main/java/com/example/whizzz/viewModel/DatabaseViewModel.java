...
public class DatabaseViewModel extends ViewModel {
    ...
    public void addChatDb(String receiverId, String senderId, String message, String timestamp, String symmetricKey) {
        successAddChatDb = instance.addChatsInDatabase(receiverId, senderId, message, timestamp, symmetricKey);
    }
